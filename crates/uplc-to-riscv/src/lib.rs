...
impl Compiler {
    ...
    pub fn compile(&self, uplc_code: &str) -> Result<String> {
        // Parse the UPLC code
        let program: Program<Name> = parser::program(uplc_code)
    ...
    #[allow(dead_code)]
    fn compile_builtin(&self, generator: &mut CodeGenerator, builtin: DefaultFunction) -> Result<()> {
        match builtin {
            DefaultFunction::AddInteger => {
                ...
                generator.add_instruction(Instruction::Add(Register::A0, Register::A0, Register::A1));
            ...
            DefaultFunction::SubtractInteger => {
                ...
                generator.add_instruction(Instruction::Sub(Register::A0, Register::A0, Register::A1));
                generator.add_instruction(Instruction::Addi(Register::Sp, Register::Sp, 4));
                generator.add_instruction(Instruction::Sw(Register::A0, 0, Register::Sp));
            }
            DefaultFunction::MultiplyInteger => {
                generator.add_instruction(Instruction::Lw(Register::A0, 0, Register::Sp));
                generator.add_instruction(Instruction::Lw(Register::A1, 4, Register::Sp));
                generator.add_instruction(Instruction::Mul(Register::A0, Register::A0, Register::A1));
                generator.add_instruction(Instruction::Addi(Register::Sp, Register::Sp, 4));
                generator.add_instruction(Instruction::Sw(Register::A0, 0, Register::Sp));
            }
            DefaultFunction::DivideInteger => {
                generator.add_instruction(Instruction::Lw(Register::A0, 4, Register::Sp));
                generator.add_instruction(Instruction::Lw(Register::A1, 0, Register::Sp));
                generator.add_instruction(Instruction::Div(Register::A0, Register::A0, Register::A1));
                generator.add_instruction(Instruction::Addi(Register::Sp, Register::Sp, 4));
                generator.add_instruction(Instruction::Sw(Register::A0, 0, Register::Sp));
            }
            DefaultFunction::RemainderInteger => {
                generator.add_instruction(Instruction::Lw(Register::A0, 4, Register::Sp));
                generator.add_instruction(Instruction::Lw(Register::A1, 0, Register::Sp));
                generator.add_instruction(Instruction::Rem(Register::A0, Register::A0, Register::A1));
                generator.add_instruction(Instruction::Addi(Register::Sp, Register::Sp, 4));
                generator.add_instruction(Instruction::Sw(Register::A0, 0, Register::Sp));
            }
            DefaultFunction::LessThanInteger => {
                generator.add_instruction(Instruction::Lw(Register::A0, 4, Register::Sp));
                generator.add_instruction(Instruction::Lw(Register::A1, 0, Register::Sp));
                generator.add_instruction(Instruction::Slt(Register::A0, Register::A0, Register::A1));
                generator.add_instruction(Instruction::Addi(Register::Sp, Register::Sp, 4));
                generator.add_instruction(Instruction::Sw(Register::A0, 0, Register::Sp));
            }
            DefaultFunction::LessThanEqualsInteger => {
                generator.add_instruction(Instruction::Lw(Register::A0, 4, Register::Sp));
                generator.add_instruction(Instruction::Lw(Register::A1, 0, Register::Sp));
                generator.add_instruction(Instruction::Slt(Register::A0, Register::A1, Register::A0));
            ...
            DefaultFunction::AppendByteString => {
                ...
                generator.add_instruction(Instruction::Add(Register::T2, Register::T0, Register::T1));
                ...
                generator.add_instruction(Instruction::Add(Register::A0, Register::T3, Register::T1)); // Destination (result + 4 + length1)
                ...
                generator.add_instruction(Instruction::Sw(Register::T3, 0, Register::Sp)); // Store result
            }
            ...
            DefaultFunction::SliceByteString => {
                ...
                generator.add_instruction(Instruction::Bge(Register::A2, Register::T0, "slice_empty".to_string()));
                
                // Calculate how many bytes we can actually take
                generator.add_instruction(Instruction::Sub(Register::T1, Register::T0, Register::A2)); // Available bytes
                generator.add_instruction(Instruction::Bge(Register::A1, Register::T1, "slice_remaining".to_string()));
                generator.add_instruction(Instruction::Mv(Register::T1, Register::A1)); // Use requested length
                generator.add_instruction(Instruction::Jal(Register::Zero, "slice_allocate".to_string()));
                ...
                generator.add_instruction(Instruction::Lw(Register::A2, 8, Register::Sp)); // Start index
                generator.add_instruction(Instruction::Addi(Register::A0, Register::T3, 4)); // Destination (result + 4)
                generator.add_instruction(Instruction::Add(Register::A1, Register::A1, Register::A2)); // Source (original + start)
                ...
                generator.add_instruction(Instruction::Jal(Register::Zero, "slice_done".to_string()));
            ...
            DefaultFunction::IndexByteString => {
                ...
                generator.add_instruction(Instruction::Bge(Register::A0, Register::T0, "index_error".to_string()));
                
                // Load the byte at the specified index
                generator.add_instruction(Instruction::Add(Register::A0, Register::A0, Register::A1)); // ByteString + index
                generator.add_instruction(Instruction::Addi(Register::A0, Register::A0, 4)); // Adjust for header
                generator.add_instruction(Instruction::Lbu(Register::A0, 0, Register::A0)); // Load byte
                
                generator.add_instruction(Instruction::Jal(Register::Zero, "index_done".to_string()));
            ...
            DefaultFunction::EqualsByteString => {
                ...
                generator.add_instruction(Instruction::Bne(Register::T0, Register::T1, "not_equal".to_string()));
                ...
                generator.add_instruction(Instruction::Jal(Register::Zero, "equals_done".to_string()));
    ...
    fn parse_uplc(&self, uplc_code: &str) -> Result<Program<Name>> {
        parser::program(uplc_code)
            .map_err(|err| CompilationError::Parse(err.to_string()))
    }

    /// Generate program setup for BitVMX
    fn generate_bitvm_program_setup(&self, generator: &mut risc_v_gen::BitVMXCodeGenerator, program: &Program<Name>) -> Result<()> {
        // Set up the program header
        let _ = generator.add_instruction(risc_v_gen::Instruction::Comment(format!("UPLC Program (version {:?})", program.version).to_string()))
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
        let _ = generator.add_instruction(risc_v_gen::Instruction::Global("_start".to_string()))
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
        let _ = generator.add_instruction(risc_v_gen::Instruction::Label("_start".to_string()))
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
        
        // Set up the stack pointer
        let _ = generator.add_instruction(risc_v_gen::Instruction::Li(risc_v_gen::Register::Sp, 0x10000))
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
        
        // Set up the environment pointer (S0)
        let _ = generator.add_instruction(risc_v_gen::Instruction::Mv(risc_v_gen::Register::S0, risc_v_gen::Register::Sp))
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
    ...
    fn generate_bitvm_program_teardown(&self, generator: &mut risc_v_gen::BitVMXCodeGenerator) -> Result<()> {
        // Set up the program footer
        let _ = generator.add_instruction(risc_v_gen::Instruction::Label("exit".to_string()))
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
        let _ = generator.add_instruction(risc_v_gen::Instruction::Li(risc_v_gen::Register::A0, 0))
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
        let _ = generator.add_instruction(risc_v_gen::Instruction::Li(risc_v_gen::Register::A7, 93)) // exit syscall
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
        let _ = generator.add_instruction(risc_v_gen::Instruction::Comment("End of program".to_string()))
            .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
    ...
    fn compile_bitvm_ir(&self, generator: &mut risc_v_gen::BitVMXCodeGenerator, instructions: &[IRInstr], execution_trace: &mut ExecutionTrace) -> Result<()> {
        ...
        for instruction in instructions {
            match instruction {
                IRInstr::PushConst(value) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Push constant {}", value)))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    
                    // Load the constant into a register
                    generator.add_instruction(risc_v_gen::Instruction::Li(risc_v_gen::Register::A0, *value as i32))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    generator.add_instruction(risc_v_gen::Instruction::Addi(risc_v_gen::Register::Sp, risc_v_gen::Register::Sp, -4))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    generator.add_instruction(risc_v_gen::Instruction::Sw(risc_v_gen::Register::A0, 0, risc_v_gen::Register::Sp))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                ...
                IRInstr::PushBool(value) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Push boolean {}", value)))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    
                    // Load boolean into register
                    generator.add_instruction(risc_v_gen::Instruction::Li(risc_v_gen::Register::A0, if *value { 1 } else { 0 }))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                ...
                IRInstr::PushVar(name) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Push variable {}", name)))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let lw_instr = risc_v_gen::Instruction::Lw(risc_v_gen::Register::A0, 0, risc_v_gen::Register::S0);
                    generator.add_instruction(lw_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                ...
                IRInstr::CallBuiltin(builtin) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Call builtin {:?}", builtin)))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let lw_instr1 = risc_v_gen::Instruction::Lw(risc_v_gen::Register::A1, 0, risc_v_gen::Register::Sp);
                    generator.add_instruction(lw_instr1.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let addi_instr1 = risc_v_gen::Instruction::Addi(risc_v_gen::Register::Sp, risc_v_gen::Register::Sp, 4);
                    generator.add_instruction(addi_instr1.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    
                    let lw_instr2 = risc_v_gen::Instruction::Lw(risc_v_gen::Register::A0, 0, risc_v_gen::Register::Sp);
                    generator.add_instruction(lw_instr2.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    // Increment stack pointer
                    let addi_instr2 = risc_v_gen::Instruction::Addi(risc_v_gen::Register::Sp, risc_v_gen::Register::Sp, 4);
                    generator.add_instruction(addi_instr2.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    match builtin {
                        DefaultFunction::AddInteger => {
                            let add_instr = risc_v_gen::Instruction::Add(risc_v_gen::Register::A0, risc_v_gen::Register::A0, risc_v_gen::Register::A1);
                            generator.add_instruction(add_instr.clone())
                                .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let addi_instr3 = risc_v_gen::Instruction::Addi(risc_v_gen::Register::Sp, risc_v_gen::Register::Sp, -4);
                    generator.add_instruction(addi_instr3.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    
                    // Store result on stack
                    let sw_instr = risc_v_gen::Instruction::Sw(risc_v_gen::Register::A0, 0, risc_v_gen::Register::Sp);
                    generator.add_instruction(sw_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                ...
                IRInstr::Apply => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment("Apply function to argument".to_string()))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let jalr_instr = risc_v_gen::Instruction::Jalr(risc_v_gen::Register::Ra, risc_v_gen::Register::A0, 0);
                    generator.add_instruction(jalr_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    
                    // Create execution step for function call
                    let pc = generator.current_pc();
                    let step = ExecutionStep::new(pc, pc, 0x12345678, 0x1000, execution_trace.current_step) // Placeholder next PC
                        .with_read1(0x1000, 0x2000, 0) // Placeholder register read (A0)
                ...
                IRInstr::Lambda(name) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Create lambda {}", name)))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let sw_instr1 = risc_v_gen::Instruction::Sw(risc_v_gen::Register::S0, 0, risc_v_gen::Register::Sp);
                    generator.add_instruction(sw_instr1.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let addi_instr = risc_v_gen::Instruction::Addi(risc_v_gen::Register::Sp, risc_v_gen::Register::Sp, -8);
                    generator.add_instruction(addi_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                ...
                IRInstr::Return => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment("Return from function".to_string()))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let lw_instr = risc_v_gen::Instruction::Lw(risc_v_gen::Register::A0, 0, risc_v_gen::Register::Sp);
                    generator.add_instruction(lw_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    // Increment stack pointer
                    let addi_instr = risc_v_gen::Instruction::Addi(risc_v_gen::Register::Sp, risc_v_gen::Register::Sp, 4);
                    generator.add_instruction(addi_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    // Return to caller
                    let jalr_instr = risc_v_gen::Instruction::Jalr(risc_v_gen::Register::Zero, risc_v_gen::Register::Ra, 0);
                    generator.add_instruction(jalr_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                ...
                IRInstr::Delay => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment("Delay computation".to_string()))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Addi(Register::A0, Register::Zero, 8)); // Size of thunk (2 words)
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Jal(Register::Ra, "malloc".to_string()));
                    
                    // Set the thunk type (1 = delayed computation)
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Li(Register::T0, 1));
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Sw(Register::T0, 0, Register::A0));
                    
                    // Store the current stack pointer (environment) in the thunk
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Sw(Register::Sp, 4, Register::A0));
                    
                    // Return the thunk
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Mv(Register::A0, Register::A0));
                    
                    // Push the thunk on the stack
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Addi(Register::Sp, Register::Sp, -4));
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Sw(Register::A0, 0, Register::Sp));
                }
                IRInstr::Force => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment("Force delayed computation".to_string()))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    // Force evaluates a delayed computation (thunk)
                    
                    // Load the thunk from the stack
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Lw(Register::A0, 0, Register::Sp));
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Addi(Register::Sp, Register::Sp, 4));
                    
                    // Check if it's a thunk (type = 1)
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Lw(Register::T0, 0, Register::A0));
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Li(Register::T1, 1));
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Bne(Register::T0, Register::T1, "force_error".to_string()));
                    
                    // Load the environment pointer
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Lw(Register::T0, 4, Register::A0));
                    
                    // Save the current stack pointer
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Mv(Register::T1, Register::Sp));
                    
                    // Set the stack pointer to the environment
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Mv(Register::Sp, Register::T0));
                    
                    // TODO: Execute the thunk code
                    // For now, we just restore the stack pointer
                    
                    // Restore the stack pointer
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Mv(Register::Sp, Register::T1));
                    
                    // Error handling
                    let _ = generator.add_instruction(risc_v_gen::Instruction::Label("force_error".to_string()));
                    // TODO: Proper error handling
                }
                IRInstr::PushByteString(bytes) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Push bytestring of length {}", bytes.len())))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let addi_instr1 = risc_v_gen::Instruction::Addi(risc_v_gen::Register::Sp, risc_v_gen::Register::Sp, -(bytes.len() as i32 + 4));
                    generator.add_instruction(addi_instr1.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    // Store length
                    let li_instr = risc_v_gen::Instruction::Li(risc_v_gen::Register::A0, bytes.len() as i32);
                    generator.add_instruction(li_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    
                    let sw_instr1 = risc_v_gen::Instruction::Sw(risc_v_gen::Register::A0, 0, risc_v_gen::Register::Sp);
                    generator.add_instruction(sw_instr1.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let sw_instr2 = risc_v_gen::Instruction::Sw(risc_v_gen::Register::A0, 4, risc_v_gen::Register::Sp);
                    generator.add_instruction(sw_instr2.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                ...
                IRInstr::PushString(s) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Push string \"{}\"", s)))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let addi_instr1 = risc_v_gen::Instruction::Addi(risc_v_gen::Register::Sp, risc_v_gen::Register::Sp, -(s.len() as i32 + 4));
                    generator.add_instruction(addi_instr1.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    // Store length
                    let li_instr = risc_v_gen::Instruction::Li(risc_v_gen::Register::A0, s.len() as i32);
                    generator.add_instruction(li_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                ...
                IRInstr::PushUnit => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment("Push unit".to_string()))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let pc = generator.current_pc();
                    let step = ExecutionStep::new(pc, pc, 0x12345678, pc + 4, execution_trace.current_step); // Placeholder opcode value
                    execution_trace.add_step(step);
                ...
                IRInstr::CaseStart(num_branches) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Case expression with {} branches", num_branches)))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let step = ExecutionStep::new(pc, opcode_addr, opcode_value, pc + 4, execution_trace.current_step)
                ...
                IRInstr::CaseBranch(branch_index) => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment(format!("Case branch {}", branch_index)))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    
                    // Compare the constructor value with the branch index
                    let li_instr = risc_v_gen::Instruction::Li(risc_v_gen::Register::A1, *branch_index as i32);
                    generator.add_instruction(li_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let beq_instr = risc_v_gen::Instruction::Beq(risc_v_gen::Register::A0, risc_v_gen::Register::A1, format!("case_branch_{}", branch_index));
                    generator.add_instruction(beq_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    ...
                    let label_instr = risc_v_gen::Instruction::Label(format!("case_branch_{}", branch_index));
                    generator.add_instruction(label_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                }
                IRInstr::CaseBranchEnd => {
                    generator.add_instruction(risc_v_gen::Instruction::Comment("End of case branch".to_string()))
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
                    
                    // Jump to the end of the case expression
                    let j_instr = risc_v_gen::Instruction::Jal(risc_v_gen::Register::Zero, "case_end".to_string());
                    generator.add_instruction(j_instr.clone())
                        .map_err(|e| CompilationError::BitVMXCodeGen(e))?;
